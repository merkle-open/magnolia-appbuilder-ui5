package com.namics.oss.magnolia.appbuilder.ui5.builder.generated.choosedialog;
...
@Generated(
		...
		date = "2020-06-15T13:24:01.961436"
)
public class ChooseDialogBuilder extends ConfiguredChooseDialogDefinition {
	public ChooseDialogBuilder i18nBasename(String i18nBasename) {
		this.setI18nBasename(i18nBasename);
		return this;
	}

	public ChooseDialogBuilder action(ActionDefinition action) {
		this.addAction(action);
		return this;
	}

	public ChooseDialogBuilder presenterClass(Class<? extends DialogPresenter> presenterClass) {
		this.setPresenterClass(presenterClass);
		return this;
	}

	public ChooseDialogBuilder actionArea(EditorActionAreaDefinition actionArea) {
		this.setActionArea(actionArea);
		return this;
	}

	public ChooseDialogBuilder modalityLevel(OverlayLayer.ModalityLevel modalityLevel) {
		this.setModalityLevel(modalityLevel);
		return this;
	}

	public ChooseDialogBuilder wide(boolean wide) {
		this.setWide(wide);
		return this;
	}

	public ChooseDialogBuilder id(String id) {
		this.setId(id);
		return this;
	}

	public ChooseDialogBuilder label(String label) {
		this.setLabel(label);
		return this;
	}

	public ChooseDialogBuilder actions(Map<String, ActionDefinition> actions) {
		this.setActions(actions);
		return this;
	}

	public ChooseDialogBuilder field(FieldDefinition field) {
		this.setField(field);
		return this;
	}

	public ChooseDialogBuilder contentConnector(ContentConnectorDefinition contentConnector) {
		this.setContentConnector(contentConnector);
		return this;
	}

	public ChooseDialogBuilder actions(String key1, ActionDefinition value1) {
	...
	public ChooseDialogBuilder actions(String key1, ActionDefinition value1, String key2,
