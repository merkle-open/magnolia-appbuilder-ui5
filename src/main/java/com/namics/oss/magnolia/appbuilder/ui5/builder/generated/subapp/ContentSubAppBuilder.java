...
@Generated(
		...
		date = "2020-06-15T13:24:00.977145"
)
public class ContentSubAppBuilder extends ConfiguredContentSubAppDescriptor {
	public ContentSubAppBuilder name(String name) {
		this.setName(name);
		return this;
	}

	public ContentSubAppBuilder closable(boolean closable) {
	...
	public ContentSubAppBuilder icon(String icon) {
		this.setIcon(icon);
		return this;
	}
	...
	public ContentSubAppBuilder actions(Map<String, ActionDefinition> actions) {
		this.setActions(actions);
		return this;
	}

	public ContentSubAppBuilder actionbar(ActionbarDefinition actionbar) {
	...
	public ContentSubAppBuilder contentConnector(ContentConnectorDefinition contentConnector) {
		this.setContentConnector(contentConnector);
		return this;
	}

	public ContentSubAppBuilder actions(String key1, ActionDefinition value1) {
	...
	public ContentSubAppBuilder actions(String key1, ActionDefinition value1, String key2,
