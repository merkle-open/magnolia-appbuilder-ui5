...
@Generated(
		...
		date = "2020-06-15T13:24:01.086972"
)
public class DetailSubAppBuilder extends ConfiguredDetailSubAppDescriptor {
	public DetailSubAppBuilder name(String name) {
		this.setName(name);
		return this;
	}

	public DetailSubAppBuilder closable(boolean closable) {
	...
	public DetailSubAppBuilder icon(String icon) {
		this.setIcon(icon);
		return this;
	}
	...
	public DetailSubAppBuilder actions(Map<String, ActionDefinition> actions) {
		this.setActions(actions);
		return this;
	}

	public DetailSubAppBuilder actionbar(ActionbarDefinition actionbar) {
	...
	public DetailSubAppBuilder contentConnector(ContentConnectorDefinition contentConnector) {
		this.setContentConnector(contentConnector);
		return this;
	}

	public DetailSubAppBuilder editor(EditorDefinition editor) {
		this.setEditor(editor);
		return this;
	}

	public DetailSubAppBuilder actions(String key1, ActionDefinition value1) {
	...
	public DetailSubAppBuilder actions(String key1, ActionDefinition value1, String key2,
