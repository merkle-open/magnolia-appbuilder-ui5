...
@Generated(
		...
		date = "2020-06-15T13:24:00.847510"
)
public class SubAppBuilder extends ConfiguredSubAppDescriptor {
	public SubAppBuilder name(String name) {
		this.setName(name);
		return this;
	}

	public SubAppBuilder closable(boolean closable) {
		this.setClosable(closable);
		return this;
	}

	public SubAppBuilder label(String label) {
		this.setLabel(label);
		return this;
	}

	public SubAppBuilder icon(String icon) {
		this.setIcon(icon);
		return this;
	}
	...
	public SubAppBuilder actions(Map<String, ActionDefinition> actions) {
		this.setActions(actions);
		return this;
	}

	public SubAppBuilder actions(String key1, ActionDefinition value1) {
	...
	public SubAppBuilder actions(String key1, ActionDefinition value1, String key2,
