package com.namics.oss.magnolia.appbuilder.ui5.builder.generated.subapp;
...
@Generated(
		...
		date = "2020-06-15T13:24:01.132598"
)
public class ToolsSubAppBuilder extends ConfiguredToolsSubAppDescriptor {
	public ToolsSubAppBuilder name(String name) {
		this.setName(name);
		return this;
	}

	public ToolsSubAppBuilder closable(boolean closable) {
		this.setClosable(closable);
		return this;
	}

	public ToolsSubAppBuilder label(String label) {
		this.setLabel(label);
		return this;
	}

	public ToolsSubAppBuilder icon(String icon) {
		this.setIcon(icon);
		return this;
	}

	public ToolsSubAppBuilder subAppClass(Class<? extends SubApp> subAppClass) {
		this.setSubAppClass(subAppClass);
		return this;
	}

	public ToolsSubAppBuilder actions(Map<String, ActionDefinition> actions) {
		this.setActions(actions);
		return this;
	}

	public ToolsSubAppBuilder description(String description) {
		this.setDescription(description);
		return this;
	}

	public ToolsSubAppBuilder tools(Map<String, ToolDefinition> tools) {
		this.setTools(tools);
		return this;
	}

	public ToolsSubAppBuilder actions(String key1, ActionDefinition value1) {
	...
	public ToolsSubAppBuilder actions(String key1, ActionDefinition value1, String key2,
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		this.setTools(paramMap);
		return this;
	}

	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		this.setTools(paramMap);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3, String key4, ToolDefinition value4) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3, String key4, ToolDefinition value4,
			String key5, ToolDefinition value5) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3, String key4, ToolDefinition value4,
			String key5, ToolDefinition value5, String key6, ToolDefinition value6) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3, String key4, ToolDefinition value4,
			String key5, ToolDefinition value5, String key6, ToolDefinition value6, String key7,
			ToolDefinition value7) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3, String key4, ToolDefinition value4,
			String key5, ToolDefinition value5, String key6, ToolDefinition value6, String key7,
			ToolDefinition value7, String key8, ToolDefinition value8) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			ToolDefinition value2, String key3, ToolDefinition value3, String key4, ToolDefinition value4,
			String key5, ToolDefinition value5, String key6, ToolDefinition value6, String key7,
			ToolDefinition value7, String key8, ToolDefinition value8, String key9, ToolDefinition value9) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			String key5, ToolDefinition value5, String key6, ToolDefinition value6, String key7,
			ToolDefinition value7, String key8, ToolDefinition value8, String key9, ToolDefinition value9,
			String key10, ToolDefinition value10) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			String key5, ToolDefinition value5, String key6, ToolDefinition value6, String key7,
			ToolDefinition value7, String key8, ToolDefinition value8, String key9, ToolDefinition value9,
			String key10, ToolDefinition value10, String key11, ToolDefinition value11) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			String key5, ToolDefinition value5, String key6, ToolDefinition value6, String key7,
			ToolDefinition value7, String key8, ToolDefinition value8, String key9, ToolDefinition value9,
			String key10, ToolDefinition value10, String key11, ToolDefinition value11, String key12,
			ToolDefinition value12) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value7, String key8, ToolDefinition value8, String key9, ToolDefinition value9,
			String key10, ToolDefinition value10, String key11, ToolDefinition value11, String key12,
			ToolDefinition value12, String key13, ToolDefinition value13) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value7, String key8, ToolDefinition value8, String key9, ToolDefinition value9,
			String key10, ToolDefinition value10, String key11, ToolDefinition value11, String key12,
			ToolDefinition value12, String key13, ToolDefinition value13, String key14,
			ToolDefinition value14) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			String key10, ToolDefinition value10, String key11, ToolDefinition value11, String key12,
			ToolDefinition value12, String key13, ToolDefinition value13, String key14,
			ToolDefinition value14, String key15, ToolDefinition value15) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			String key10, ToolDefinition value10, String key11, ToolDefinition value11, String key12,
			ToolDefinition value12, String key13, ToolDefinition value13, String key14,
			ToolDefinition value14, String key15, ToolDefinition value15, String key16,
			ToolDefinition value16) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value12, String key13, ToolDefinition value13, String key14,
			ToolDefinition value14, String key15, ToolDefinition value15, String key16,
			ToolDefinition value16, String key17, ToolDefinition value17) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value12, String key13, ToolDefinition value13, String key14,
			ToolDefinition value14, String key15, ToolDefinition value15, String key16,
			ToolDefinition value16, String key17, ToolDefinition value17, String key18,
			ToolDefinition value18) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value14, String key15, ToolDefinition value15, String key16,
			ToolDefinition value16, String key17, ToolDefinition value17, String key18,
			ToolDefinition value18, String key19, ToolDefinition value19) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value14, String key15, ToolDefinition value15, String key16,
			ToolDefinition value16, String key17, ToolDefinition value17, String key18,
			ToolDefinition value18, String key19, ToolDefinition value19, String key20,
			ToolDefinition value20) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value16, String key17, ToolDefinition value17, String key18,
			ToolDefinition value18, String key19, ToolDefinition value19, String key20,
			ToolDefinition value20, String key21, ToolDefinition value21) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value16, String key17, ToolDefinition value17, String key18,
			ToolDefinition value18, String key19, ToolDefinition value19, String key20,
			ToolDefinition value20, String key21, ToolDefinition value21, String key22,
			ToolDefinition value22) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value18, String key19, ToolDefinition value19, String key20,
			ToolDefinition value20, String key21, ToolDefinition value21, String key22,
			ToolDefinition value22, String key23, ToolDefinition value23) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value18, String key19, ToolDefinition value19, String key20,
			ToolDefinition value20, String key21, ToolDefinition value21, String key22,
			ToolDefinition value22, String key23, ToolDefinition value23, String key24,
			ToolDefinition value24) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
	...
	public ToolsSubAppBuilder tools(String key1, ToolDefinition value1, String key2,
			...
			ToolDefinition value20, String key21, ToolDefinition value21, String key22,
			ToolDefinition value22, String key23, ToolDefinition value23, String key24,
			ToolDefinition value24, String key25, ToolDefinition value25) {
		Map<String, ToolDefinition> paramMap = new HashMap<>();
		paramMap.put(key1, value1);
		paramMap.put(key2, value2);
		paramMap.put(key3, value3);
