...
@Generated(
		...
		date = "2020-06-15T13:24:01.486793"
)
public class ChainedActionBuilder extends ChainedActionDefinition {
	public ChainedActionBuilder name(String name) {
		this.setName(name);
		return this;
	}

	public ChainedActionBuilder i18nBasename(String i18nBasename) {
		this.setI18nBasename(i18nBasename);
		return this;
	}

	public ChainedActionBuilder availability(AvailabilityDefinition availability) {
		this.setAvailability(availability);
		return this;
	}

	public ChainedActionBuilder successMessage(String successMessage) {
		this.setSuccessMessage(successMessage);
		return this;
	}

	public ChainedActionBuilder failureMessage(String failureMessage) {
		this.setFailureMessage(failureMessage);
		return this;
	}

	public ChainedActionBuilder errorMessage(String errorMessage) {
		this.setErrorMessage(errorMessage);
		return this;
	}

	public ChainedActionBuilder label(String label) {
		this.setLabel(label);
		return this;
	}

	public ChainedActionBuilder icon(String icon) {
		this.setIcon(icon);
		return this;
	}

	public ChainedActionBuilder implementationClass(Class<? extends Action> implementationClass) {
		this.setImplementationClass(implementationClass);
		return this;
	}

	public ChainedActionBuilder description(String description) {
		this.setDescription(description);
		return this;
	}

	public ChainedActionBuilder actions(Map<String, ActionDefinition> actions) {
		this.setActions(actions);
		return this;
	}

	public ChainedActionBuilder actions(String key1, ActionDefinition value1) {
	...
	public ChainedActionBuilder actions(String key1, ActionDefinition value1, String key2,
