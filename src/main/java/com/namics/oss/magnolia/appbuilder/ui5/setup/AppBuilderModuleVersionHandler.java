package com.namics.oss.magnolia.appbuilder.ui5.setup;
...
public class AppBuilderModuleVersionHandler extends DefaultModuleVersionHandler {

	private static final String SNAPSHOT_CLASSIFIER = "SNAPSHOT";

	private final List<Task> tasks;

	public AppBuilderModuleVersionHandler() {
